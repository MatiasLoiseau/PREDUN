...
SELECT
    ...
    (payload->>'FECHA')::date        AS fecha,
    (payload->>'FECHA_VIGENCIA')::date AS fecha_vigencia,
...
SELECT
    ...
    (payload->>'anio_academico')::int   AS anio_academico,
    (payload->>'fecha_inscripcion')::timestamptz      AS fecha_inscripcion,
    ...
    (payload->>'fecha_nacimiento')::date             AS fecha_nacimiento,
...
SELECT
    academic_period,
    (payload->>'registro_id')::int             AS registro_id,
    ...
    (payload->>'porcentaje_avance')::numeric   AS porcentaje_avance,
